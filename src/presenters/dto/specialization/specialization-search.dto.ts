...
export class SpecializationSearchDto implements IFindPaginateCriteria<ISpecialization>, hrm.core.ISpecializationSearchRequest {
  @IsNumber()
  @Transform(Number)
  ...
  @ValidateNested()
  @Type(() => SortFieldDto)
  readonly sort?: Array<SortFieldDto<ISpecialization>>;
