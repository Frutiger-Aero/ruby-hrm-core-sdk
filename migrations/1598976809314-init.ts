...
export class init1598976809314 implements MigrationInterface {
    name = 'init1598976809314'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."executor" ADD CONSTRAINT "FK_be129b73d24afd91b8bf634e498" FOREIGN KEY ("tariffId") REFERENCES "hrm_core"."tariff"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."executor" DROP CONSTRAINT "FK_be129b73d24afd91b8bf634e498"`);
