...
export class init1599146281929 implements MigrationInterface {
    name = 'init1599146281929'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "hrm_core"."executor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "is_deleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "sso_id" character varying NOT NULL, "address" character varying NOT NULL, "photo" character varying, "accepted_use_terms" character varying, "passport" text NOT NULL, "status" smallint NOT NULL, "status_reason" character varying, "status_date" character varying, "rating" double precision NOT NULL DEFAULT 0, "citizenship_id" uuid, "tariff_id" uuid, CONSTRAINT "UQ_2c8cf4db046110ea173735d8db8" UNIQUE ("sso_id"), CONSTRAINT "PK_08a1aecf4d1a693a51ee75149fa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hrm_core"."log" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "is_deleted" boolean NOT NULL DEFAULT false, "deleted_at" TIMESTAMP WITH TIME ZONE, "type" smallint NOT NULL, "name" character varying NOT NULL, "old_value" character varying, "new_value" character varying NOT NULL, "entity_id" character varying NOT NULL, CONSTRAINT "PK_e3ef2ec7ab0615d590f6f2c29a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."executor" ADD CONSTRAINT "FK_dffc95c83c1c1c00740a4db5553" FOREIGN KEY ("citizenship_id") REFERENCES "hrm_core"."citizenship"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."executor" DROP CONSTRAINT "FK_dffc95c83c1c1c00740a4db5553"`);
        ...
        await queryRunner.query(`DROP TABLE "hrm_core"."log"`);
