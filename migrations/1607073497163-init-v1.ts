...
export class initV11607073497163 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "hrm_core"."compensations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "type" character varying NOT NULL DEFAULT 'FIXED', "option" character varying(256) NOT NULL, "grade_id" uuid NOT NULL, CONSTRAINT "PK_245c43116f1346cf8cf722ec9b7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."compensations" ADD CONSTRAINT "FK_b0acd5e28425109560db24498c3" FOREIGN KEY ("grade_id") REFERENCES "hrm_core"."grades"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "hrm_core"."grades" ADD CONSTRAINT "FK_0a34b9b8d574307510c225eda43" FOREIGN KEY ("wage_id") REFERENCES "hrm_core"."wages"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
